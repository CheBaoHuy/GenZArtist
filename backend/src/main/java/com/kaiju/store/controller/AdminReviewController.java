...
public class AdminReviewController {
    ...
    // public ResponseEntity<ApiResponse<Map<String, Object>>> getProductReview(@PathVariable int id) {
    //     return ResponseEntity.ok(new ApiResponse<>("success", null, reviewService.getProductReview(null, id, null)));
    // }
    ...
    //         @RequestParam(defaultValue = "1") int page,
    //         @RequestParam(defaultValue = "20") int size) {
    //     return ResponseEntity.ok(new ApiResponse<>("success", null, reviewService.getAuthorReviews(page, size, null)));
    // }
